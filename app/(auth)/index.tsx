      ...
      if (loginMethod === "email") {
        ...
        try {
          ...
          if (response.success) {
            ...
            router.push({
              pathname: "/verify-otp",
              params: { phone, request_id: response.request_id },
            });
          }
        } catch (error: any) {
        ...
        <View style={[styles.formContainer, { maxWidth: containerMaxWidth }]}>
            ...
            >
              <Text
                style={[
                  styles.methodText,
                  { color: colors.text },
                  loginMethod === "email" && activeMethodStyle,
                ]}
              >
                Email
              </Text>
            ...
            >
              <Text
                style={[
                  styles.methodText,
                  { color: colors.text },
                  loginMethod === "phone" && activeMethodStyle,
                ]}
              >
                Téléphone
              </Text>
          ...
          <View style={styles.form}>
            ...
            <Button
              loading={loading}
              title={
                loginMethod === "email" ? "Se connecter" : "Recevoir le code"
              }
